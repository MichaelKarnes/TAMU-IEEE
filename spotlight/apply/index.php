	...
	<div id="page-wrapper" class="5grid-layout">
		<div class="5grid-layout">
			<div class="row">
				<div class="12u">
					<div id="content">
						<h2>Application for IEEE Spotlight</h2>
                        <form action="../../actions/spotlight.php" method="post">
                            <label for="first">First Name</label><br>
                            <input type="text" name="first" style="width: 450px;" required /><br>
                            <br>
                            <label for="last">Last Name</label><br>
                            <input type="text" name="last" style="width: 450px;" required /><br>
                            <br>
                            <label for="email">Email</label><br>
                            <input type="email" name="email" style="width: 450px;" required /><br>
                            <br>
                            <p>Please provide the URL for an image, video, or website for this project.</p>
                            <input type="url" name="url" style="width: 450px;" required /><br>
                            <br>
                            <p>Please provide a <u>brief</u> description of your project.</p>
                            <textarea name="desc" style="width: 450px; height: 100px; resize: vertical;" required></textarea><br>
                            <br>
