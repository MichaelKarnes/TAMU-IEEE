...
$content = preg_replace('/</h2>/', '</td></tr><tr><td height="18"></td></tr>', $content);
    ...
    <head>
        ...
        <style type="text/css">
            /*@media screen and (max-device-width: 600px) {
                .date {
                    color: #ffffff !important; font-size: 10px; line-height: 10px; font-family: 'Times New Roman',serif;
                }
            }
            @media screen and (min-width: 600px) {
                .date {
                    color: #ffffff !important; font-size: 19px; line-height: 19px; font-family: 'Times New Roman',serif;
                }
            }*/
            p {
                color: #444444;
