      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active">
                <a href="pages/bulletins/index.php">
                    <i class="fa fa-envelope"></i> <span>Bulletin Management</span>
                </a>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Bulletin Management</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="row">
                                ...
                                <tr>
                                    <td bgcolor="#500001">
                                        <table border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <img src="http://www.ieeetamu.org/images/ieee_logo_newsletter.jpg" alt="Texas A&M IEEE Bulletin" width="600" height="101" style="display: block;" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center" style="color: white; font-size: 24px; line-height: 24px; font-family: 'Times New Roman',serif;">
                                                    <font color="#ffffff">Week of <?php echo $date; ?></font>
                                                </td>
                                            </tr>
                                    ...
                                    <td bgcolor="#ffffff">
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td width="540"><div id="content" style="padding: 0 0 0 0; overflow: visible;"></div></td>
                                                <td width="30" style="font-size: 0; line-height: 0;">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td width="30" height="30" style="font-size: 0; line-height: 0;">&nbsp;</td>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <div class="btn-group" style="width: 100%;">
                            <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" style="width: 100%;">Texas A&M IEEE Weekly Bulletin <span class="fa fa-caret-down" style="float: right; line-height: 18px;"></span></button>
                            <ul class="dropdown-menu" style="width: 100%;">
                                <li><a href="#">Texas A&M IEEE Weekly Bulletin</a></li>
                                <li class="divider"></li>
                                <li><a href="#">Create Bulletin Template</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group input-group-sm">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-default btn-flat" type="button">Test</button>
                            </span>
                        </div>
                    </div>
                ...
                <?php
                    $db = DB::getInstance();
                    $bulletins = $db->get('bulletins', array('id', '>', -1))->results();
                    foreach($bulletins as $bulletin) {
                ?>
                <button class="btn btn-block btn-default btn-lg" id="bulletin-<?php echo $bulletin->id; ?>"><?php echo date('F jS Y', strtotime($bulletin->date)); ?> <span class="fa fa-caret-down" style="float: right; line-height: 24px;"></span></button>
                <div id="bulletin-content-<?php echo $bulletin->id; ?>" style="display: none;"><?php echo $bulletin->content; ?></div>
                <script type="text/javascript">
                    $("#bulletin-<?php echo $bulletin->id; ?>").click(function () {
                        if($("#bulletin-content-<?php echo $bulletin->id; ?>").is(":visible")) {
                            $("#bulletin-content-<?php echo $bulletin->id; ?>").hide();
                        } else {
                            $("#bulletin-content-<?php echo $bulletin->id; ?>").show();
                            $("#bulletin-content-<?php echo $bulletin->id; ?>").animate({
                                opacity: 0.25,
                                left: "+=50",
                                height: "toggle"
                            }), 5000, function() {
